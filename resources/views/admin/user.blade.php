                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button"
                            ...
                            <div class="avatar avatar-md">
                                <img class="avatar-img" src="{{ asset('template/assets/img/avatars/8.jpg') }}"
                                    alt="user@email.com">
                            </div>
                        </a>
            ...
            <div class="container-lg">
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="fw-semibold fs-4">Users</span>
        ...
        @foreach ($users as $user)
            <div class="modal fade" id="editUserModal{{ $user->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <form class="modal-content" action="/admin/user/update/{{ $user->id }}" method="POST">
                        @csrf
                        @method('PUT')
